      ...
      <div className="relative bg-[#f7fdfd] z-50">
        <div className="container mx-auto flex items-center justify-between p-5">
          ...
          <ul className="hidden lg:flex gap-10 text-base">
            <li>
              <Link to="/" onClick={handleCloseNav}>Find Job</Link>
            </li>
            <li>
              <Link to="/" onClick={handleCloseNav}>Companies</Link>
            </li>
            <li>
              <Link to="/" onClick={handleCloseNav}>Upload Job</Link>
            </li>
            <li>
          ...
          <div className="hidden lg:block">
            {!user?.token ? (
             ...
             <div>
              <UserMenuList user={user} onClick={handleCloseNav}/>
             </div>
            )}
          </div>
        </div>
